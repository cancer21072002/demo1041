            ...
            <div class="banner">
                <div class="imga" style="position: relative;">
                    ...
                    <div class="texts" style="position: absolute; text-align: center;">
                        <h1 style="padding-top:500px ; padding-left: 100px; color:rgb(3, 2, 2); font-size:bold;">HOW TO CHOOSE PERFECT MAKEUP BRUSHES</h1>
                        

                    </div>
                    <div class="">
                        <img src="../image/blog4.jpg" alt=""  width="100%" style="max-height:600px ;" >
                    </div>
                </div>
