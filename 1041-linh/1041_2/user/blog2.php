            ...
            <div class="banner">
                <div class="imga" style="position: relative;">
                    ...
                    <div class="texts" style="position: absolute; text-align: center;">
                        <h1 style="padding-top:500px ; padding-left: 100px; color:rgb(3, 2, 2); font-size:bold;">TOP 10 HAND CREAMS FOR SOFT SKIN</h1>
                        

                    </div>
                    <div class="">
                        <img src="https://wgl-demo.net/nuage/wp-content/uploads/2021/07/jessica-weille.jpg" alt=""  width="100%" style="max-height:600px ;" >
                    </div>
                </div>
